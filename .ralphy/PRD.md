...
### Training Management
- [ ] Create `apps/web/src/components/training/training-card.tsx` - training preview card
...
- [ ] Create `apps/web/src/components/session/exercise-checklist.tsx` - checklist overlay on body visualization
